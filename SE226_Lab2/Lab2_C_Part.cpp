...
int main() {
    ...
    cout << "The words that start with letter 'e':\n";
    for (string word: words)
        if (word.at(0) == 'e')
            cout << word << endl;
    cout << "\nThe words starts with letters 'h' following 'a':\n";
    for (string word: words)
        if (word.at(0) == 'h' && word.at(1) == 'a')
            cout << word << endl;
    cout << "\n" << endl;
    /*int num;
    cout << "Please enter a num between 3-9 (inclusive): " << endl;
    cin >> num;
    if (num >= 3 && num <= 9) {
        if(num%2==0){}
        else{num=num+1;}
        ...
        int num;
        cout << "Please enter a num between 3 and 9 (inclusive):\n";
        cin >> num;
        if (num < 3 || num > 9) {cout << "Please enter a num between given range.\n";return 0;}
        for (int i = 1; i <= num; i++) {
